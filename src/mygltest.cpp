...
void TestLighting(HWND window){
    ...
    if(!init){
        init = 1;
        ShaderCreate("c:/code/fps/src/shaders/test_lighting_vertex.hlsl", "c:/code/fps/src/shaders/test_lighting_fragment.hlsl", &cube_shader);
        ShaderCreate("c:/code/fps/src/shaders/test_lighting_cube_vertex.hlsl", "c:/code/fps/src/shaders/test_lighting_cube_fragment.hlsl", &lighting_cube_shader);
...
void TestManyLights(HWND window){
    ...
    ShaderSetUniform(cube_shader, "spot_light.cutoff", cos(ToRadians(0.0f)));
    ShaderSetUniform(cube_shader, "spot_light.outercutoff", cos(ToRadians(30.0f)));
