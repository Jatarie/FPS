...
set includes_win=/I "C:\Program Files (x86)\Windows Kits\10\Include\10.0.22000.0\ucrt" /I "C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.36.32532\include" /I "C:\Program Files (x86)\Windows Kits\10\Include\10.0.22000.0\um" /I "C:\Program Files (x86)\Windows Kits\10\Include\10.0.22000.0\shared"

set LIBS=/LIBPATH:"C:\Program Files (x86)\Windows Kits\10\Lib\10.0.22000.0\um\x64" /LIBPATH:"C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.36.32532\lib\x64" /LIBPATH:"C:\Program Files (x86)\Windows Kits\10\Lib\10.0.22000.0\ucrt\x64"

cl %CommonCompilerFlags% %includes% %includes_win% ../src/mygl.cpp -LD -link %LIBS% opengl32.lib Gdi32.lib user32.lib assimp-vc143-mtd.lib /PROFILE -incremental:no -PDB:mygl_%random%.pdb -EXPORT:RenderGame
